  ...
  const tenantDefs = [
    {
      ...
      data: {
        ...
        paymentDetailsJson: {
          ...
          accountTitle: 'Iron Peak Fitness Pvt Ltd',
          accountNumber: '1234010998877',
          iban: 'PK49MEZN001234010998877',
          branchCode: '0102',
          jazzCashNumber: '03001234567',
          easyPaisaNumber: '03121234567',
          additionalInstructions: 'Please write your name in the transaction description.',
        },
      },
      pkg: entPackage,
      subStart: '2024-01-15',
    ...
    },
    {
      ...
      data: {
        ...
        paymentDetailsJson: {
          ...
          accountTitle: 'Vitality Fit Studio LLC',
          accountNumber: '9876543210',
          iban: 'PK52ALFH009876543210',
          branchCode: '0403',
          jazzCashNumber: '03211234567',
          easyPaisaNumber: '03221234567',
          additionalInstructions: 'Send confirmation receipt after payment.',
        },
      },
      pkg: proPackage,
      subStart: '2024-02-10',
    ...
    },
    {
      ...
      data: {
        ...
        paymentDetailsJson: {
          ...
          accountTitle: 'PowerZone Gym & Fitness',
          accountNumber: '111222333444',
          iban: 'PK12HABB00111222333444',
          branchCode: '0882',
          jazzCashNumber: '03451234567',
          easyPaisaNumber: '03461234567',
          additionalInstructions: 'Include your Member ID in the reference.',
        },
      },
      pkg: proPackage,
      subStart: '2024-03-20',
    ...
    },
    {
      ...
      data: {
        ...
        paymentDetailsJson: {
          ...
          accountTitle: 'FitLife Studio Islamabad',
          accountNumber: '555666777888',
          iban: 'PK88UNIL00555666777888',
          branchCode: '0901',
          jazzCashNumber: '03361234567',
          easyPaisaNumber: '03371234567',
          additionalInstructions: 'Double check the IBAN before transferring.',
        },
      },
      pkg: startPackage,
      subStart: '2024-04-05',
    ...
    },
    {
      ...
      data: {
        ...
        paymentDetailsJson: {
          ...
          accountTitle: 'Champions Athletic Club',
          accountNumber: '999888777666',
          iban: 'PK76SCBL00999888777666',
          branchCode: '0554',
          jazzCashNumber: '03121234567',
          easyPaisaNumber: '03131234567',
          additionalInstructions: 'Transfers are processed within 24 hours.',
        },
      },
      pkg: startPackage,
      subStart: '2024-05-01',
